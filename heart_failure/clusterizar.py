...
dados = pd.read_csv('dados_preprocessados_heart_failure.csv', sep = ',')
...
cluster_heart_failure = KMeans(n_clusters=numero_clusters_otimo).fit(dados)
#Salvar o modelo de clusters em disco
dump(cluster_heart_failure, open('cluster_heart_failure.model', 'wb'))
